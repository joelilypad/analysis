...
def check_password():
    ...
    def password_entered():
        ...
        if hashlib.sha256(st.session_state["password"].encode()).hexdigest() == "5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8":
    ...
    if "password_correct" not in st.session_state:
        ...
        st.markdown("""
            <div style="max-width: 400px; margin: 0 auto; padding: 2rem; text-align: center;">
                <h1 style="margin-bottom: 2rem;">🧠 Lilypad Analytics</h1>
            </div>
        """, unsafe_allow_html=True)
